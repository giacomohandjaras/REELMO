...
function   [pwr_bnd] = calcola_pwr_bnd(S,Fs,bande,TR)
...
disp(sprintf('Starting computations...it may take a while...'));
 tic
 [Pxx,freq] = pwelch(S_final,window,int32(N_win-0.001*Fs),int32(2*Fs),int32(Fs)); % overlap 75%
 toc
 all_Pxx=Pxx';
